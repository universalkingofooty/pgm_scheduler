        ...
        return `
            <div class="collapse-content details-row" data-ticket-id="${rowData.ticketID}">
                <td colspan="8">
                    ...
                    <input type="text" placeholder="Reason" class="input-bottom-border"></input>
                    <div class="d-flex justify-content-center align-items-center mt-3">
                        <div class="row">
                            <div class="col-md-6 d-flex justify-content-center">
                                <button class="form-control mt-2 employee-select comform" style="width:250px">Confirm</button>
                            </div>
                            <div class="col-md-6 d-flex justify-content-center">
